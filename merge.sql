...
-- populate students table with students 
INSERT INTO students (studentID, firstname, lastname, address, city, state, zip) VALUES
...
MERGE students 
    USING imported 
    ON imported.studentid = students.studentid
   ...
   -- For records found in the imported table, but not students, do an INSERT
   -- "TARGET" refers to the main table; in our case, students
